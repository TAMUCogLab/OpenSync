...
if __name__ == "__main__":
    ...
    while True:
        ...
        # Data looks like: '<FPOGX="0.26676" FPOGY="0.99285" FPOGS="199.84114" FPOGD="0.14601" FPOGID="352" FPOGV="1" DIAL="30" DIALV="1" GSR="67296" GSRV="1" HR="53" HRV="1" HRP="50"/>\r\n'
        ...
        m = re.search('(?<=HRP=")\d*\.\d+|\d+(?=" USER)', msg)
        if (m != None):
